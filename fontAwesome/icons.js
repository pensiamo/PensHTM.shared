import {
    ...
    faEye, faSortUp, faSortDown, faSort, faGift
...
const addFontAwesomeIconsToLibrary = () => {
    ...
    library.add(faTools, faSearch, faEraser, faCheckCircle, faTimesCircle, faEdit, faCheck,
        ...
        faBookOpen, faLink, faList, faThumbsUp, faCog, faFile, faWrench, faPhone, faGlobe, faEye, faSortUp, faSortDown, faSort, faGift);
};
