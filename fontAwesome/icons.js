import {
    ...
    faEye, faSortUp, faSortDown, faSort, faGift, faAsterisk, faPaste, faMapPin, faShippingFast, faUserAltSlash, faWindowClose
...
const addFontAwesomeIconsToLibrary = () => {
    ...
    library.add(faTools, faSearch, faEraser, faCheckCircle, faTimesCircle, faEdit, faCheck,
        ...
        faSortUp, faSortDown, faSort, faGift, faAsterisk, faPaste, faMapPin, faShippingFast, faUserAltSlash, faWindowClose);
};
